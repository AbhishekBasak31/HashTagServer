...
export const createHomeAbout = async (req, res) => {
  ...
  try {
    ...
    const textFields = [
      ...
      "outerorbitText1", "outerorbitText2", "outerorbitText3", "outerorbitText4",
      "innerorbitText1", "innerorbitText2", "innerorbitText3", "innerorbitText4"
    ];

    // 2. Define ALL Image Fields
    const imageFields = [
      "tab1Icon", "tab2Icon", "tab3Icon",
      "centerLogo",
      "outerorbitImg1", "outerorbitImg2", "outerorbitImg3", "outerorbitImg4",
      "innerorbitImg1", "innerorbitImg2", "innerorbitImg3", "innerorbitImg4"
    ];
